...
def test_filtr_airplanes_valid(
    ...
    """Тестирование фильтрации самолетов по высоте полета, заданной пользователем при правильном вводе данных"""
...
def test_filtr_airplanes_error(
    ...
    при неправильном вводе данных через дефис"""
    mock_get_airplane.return_value = airplanes_list_result
...
def test_sort_airplanes_valid(airplanes_list_result: list[dict], sort_airplanes_result: list[dict]) -> None:
    ...
    заданной пользователем при правильном вводе данных"""
...
def test_filtr_country_airplanes_valid(
    ...
    """Тестирование фильтрации списка самолетов по стране регистрации при валидных значениях"""
    mock_get_airplane.return_value = airplanes_list_result
    airplanes = WriteFileJson()
